...
namespace QuadRelate.Players.Vince.Tests
{
    public class PatternMatcherTests
    {
        ...
        {
            var actual = PatternMatcher.CountMatches(line, new Counter[]{ Counter.Yellow, Counter.Yellow, Counter.Yellow, Counter.Yellow });
        ...
        {
            var actual = PatternMatcher.CountMatches(line, new Counter[]{ Counter.Yellow, Counter.Yellow, Counter.Yellow });
        ...
        {
            var actual = PatternMatcher.CountMatches(line, new Counter[]{ Counter.Yellow, Counter.Yellow, Counter.Yellow, Counter.Empty });
        ...
        {
            var actual = PatternMatcher.CountMatches(line, new Counter[]{ Counter.Empty, Counter.Yellow, Counter.Yellow, Counter.Yellow });
